...
#define cpu_online_mask   ((const struct cpumask *)&__cpu_online_mask)	// 表示系统中有多少个正在运行的CPU
#define cpu_enabled_mask   ((const struct cpumask *)&__cpu_enabled_mask)
#define cpu_present_mask  ((const struct cpumask *)&__cpu_present_mask)	// 表示系统中具备Online条件的核心，它们不一定都处于online，有的CPU核心可能被热插拔
