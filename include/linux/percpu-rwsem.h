...
#define __DEFINE_PERCPU_RWSEM(name, is_static)                                                               \
    ...
    is_static struct percpu_rw_semaphore name = {.rss        = __RCU_SYNC_INITIALIZER (name.rss),            \
...
static inline void percpu_rwsem_release (struct percpu_rw_semaphore* sem, unsigned long ip)
{
