...
/*
 * ioport.h Definitions of routines for detecting, reserving and allocating system resources.
 *
 ...
 * nesting etc..
 * struct resource 是 Linux 内核中用于描述设备硬件资源的核心数据结构:
 *  1. 硬件资源描述
 *  2. 资源管理功能
 *  3. 兼容性和扩展性
 */
...
extern int              allocate_resource (struct resource* root,
                                           struct resource* new,
                                           resource_size_t size,
                                           resource_size_t min,
                                           resource_size_t max,
...
static inline bool
resource_intersection (const struct resource* r1, const struct resource* r2, struct resource* r)
{
...
static inline bool
resource_union (const struct resource* r1, const struct resource* r2, struct resource* r)
{
    if (!resource_overlaps (r1, r2))
        return false;
...
int find_resource_space (struct resource* root,
                         struct resource* new,
                         resource_size_t             size,
...
extern struct resource* __request_region (
        struct resource*, resource_size_t start, resource_size_t n, const char* name, int flags);
...
extern int  devm_request_resource (struct device* dev, struct resource* root, struct resource* new);
...
extern void __devm_release_region (struct device*   dev,
                                   struct resource* parent,
                                   resource_size_t  start,
                                   resource_size_t  n);
extern int  iomem_map_sanity_check (resource_size_t addr, unsigned long size);
extern bool iomem_is_exclusive (u64 addr);
extern bool resource_is_exclusive (struct resource* resource, u64 addr, resource_size_t size);

extern int  walk_system_ram_range (unsigned long start_pfn,
                                   unsigned long nr_pages,
                                   void*         arg,
                                   int (*func) (unsigned long, unsigned long, void*));
extern int  walk_mem_res (u64 start, u64 end, void* arg, int (*func) (struct resource*, void*));
extern int
walk_system_ram_res (u64 start, u64 end, void* arg, int (*func) (struct resource*, void*));
extern int
walk_system_ram_res_rev (u64 start, u64 end, void* arg, int (*func) (struct resource*, void*));
extern int walk_iomem_res_desc (unsigned long desc,
                                unsigned long flags,
                                u64           start,
                                u64           end,
                                void*         arg,
...
struct resource*
devm_request_free_mem_region (struct device* dev, struct resource* base, unsigned long size);
struct resource*
request_free_mem_region (struct resource* base, unsigned long size, const char* name);
