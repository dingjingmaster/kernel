...
#define __MUTEX_INITIALIZER(mutexname) { .rtmutex = __RT_MUTEX_BASE_INITIALIZER (mutexname.rtmutex) __DEP_MAP_MUTEX_INITIALIZER (mutexname) }

#define DEFINE_MUTEX(mutexname) struct mutex mutexname = __MUTEX_INITIALIZER (mutexname)

extern void __mutex_rt_init (struct mutex* lock, const char* name, struct lock_class_key* key);
