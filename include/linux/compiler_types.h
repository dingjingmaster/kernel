 ...
 */
#if defined(CONFIG_DEBUG_INFO_BTF) && defined(CONFIG_PAHOLE_HAS_BTF_TAG) && __has_attribute(btf_type_tag) && !defined(__BINDGEN__)
 ...
 */
#if __has_attribute(__retain__) && (defined(CONFIG_LD_DEAD_CODE_DATA_ELIMINATION) || defined(CONFIG_LTO_CLANG))
...
#define __noinstr_section(section)                                                                                                                  \
    noinline                                                                                                                                notrace \
            __attribute ((__section__ (section))) __no_kcsan __no_sanitize_address __no_profile __no_sanitize_coverage __no_sanitize_memory __signed_wrap
