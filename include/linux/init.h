 ...
 */
#            define __initcall_section(__sec, __iid) #__sec ".init.." #__iid
 ...
 */
#            define __initcall_stub(fn, __iid, id) __initcall_name (initstub, __iid, id)
...
#            define ____define_initcall(fn, __stub, __name, __sec)                                                                              \
                __define_initcall_stub (__stub, fn) asm (".section	\"" __sec                                                                   \
                                                         "\", \"a\"		\n" __stringify (__name) ":			\n"                                       \
...
#        define __unique_initcall(fn, id, __sec, __iid) \
            ____define_initcall (fn, __initcall_stub (fn, __iid, id), __initcall_name (initcall, __iid, id), __initcall_section (__sec, __iid))
...
#        define __setup_param(str, unique_id, fn, early)                                                                                          \
            ...
            static struct obs_kernel_param __setup_##unique_id __used __section (".init.setup") __aligned (__alignof__ (struct obs_kernel_param)) \
