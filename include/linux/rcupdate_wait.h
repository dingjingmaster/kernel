...
void __wait_rcu_gp (bool checktiny, unsigned int state, int n, call_rcu_func_t* crcu_array, struct rcu_synchronize* rs_array);
 ...
 * grace period.
 */
#define synchronize_rcu_mult(...) _wait_rcu_gp (IS_ENABLED (CONFIG_TINY_RCU), TASK_UNINTERRUPTIBLE, __VA_ARGS__)
