...
#    define REQUIRED_MASK_BIT_SET(feature_bit)                                             \
        (CHECK_BIT_IN_MASK_WORD (REQUIRED_MASK, 0, feature_bit) ||                         \
         ...
         CHECK_BIT_IN_MASK_WORD (REQUIRED_MASK, 21, feature_bit) || REQUIRED_MASK_CHECK || \
...
#    define DISABLED_MASK_BIT_SET(feature_bit)                                             \
        (CHECK_BIT_IN_MASK_WORD (DISABLED_MASK, 0, feature_bit) ||                         \
         ...
         CHECK_BIT_IN_MASK_WORD (DISABLED_MASK, 21, feature_bit) || DISABLED_MASK_CHECK || \
         BUILD_BUG_ON_ZERO (NCAPINTS != 22))

#    define cpu_has(c, bit) \
        (__builtin_constant_p (bit) && REQUIRED_MASK_BIT_SET (bit) ? 1 : test_cpu_cap (c, bit))
...
#    define CPU_FEATURE_TYPEVAL boot_cpu_data.x86_vendor, boot_cpu_data.x86, boot_cpu_data.x86_model
